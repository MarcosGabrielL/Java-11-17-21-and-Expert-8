...
public class FI_from_API {
    ...
    public void unaryBinaryOperator() {
        ...
        /**
         * Em resumo, a diferença principal está nas interfaces utilizadas (Function e UnaryOperator) e
         *  na operação realizada. A Function é mais geral e pode ser usada para transformações de tipos 
         *  diferentes, enquanto a UnaryOperator é uma especialização específica para o caso em que a entrada 
         *  e a saída são do mesmo tipo.
         */
        ...
        /**
         * Resumindo, BinaryOperator é uma especialização da interface BiFunction para 
         * casos em que os tipos de entrada e saída são os mesmos. Neste caso específico, 
         * BinaryOperator<String> representa uma operação binária sobre strings, que é a concatenação.
         */
    }
}
